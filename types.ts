...
export type Role = 'admin' | 'manager' | 'receptionist' | 'technician' | 'accountant' | 'doctor' | 'nurse' | 'pharmacist' | 'hr' | 'staff' | 'lab_technician' | 'radiologist' | 'anesthesiologist' | 'security' | 'maintenance';
