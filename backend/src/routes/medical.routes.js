...
router.post('/lab/requests', authorizeRoles(Permissions.MANAGE_LABORATORY), auditLog('CREATE', 'lab_request'), medicalController.createLabRequest);
router.post('/lab/requests/:id/complete', authorizeRoles(Permissions.MANAGE_LABORATORY), auditLog('UPDATE', 'lab_request'), medicalController.completeLabRequest);
...
router.post('/nurse/requests', authorizeRoles(Permissions.VIEW_DASHBOARD), auditLog('CREATE', 'nurse_request'), medicalController.createNurseRequest);

// Medical: Operations
router.get('/operations', authorizeRoles(Permissions.VIEW_OPERATIONS), medicalController.getScheduledOperations);
router.post('/operations', authorizeRoles(Permissions.MANAGE_OPERATIONS), auditLog('CREATE', 'operation'), medicalController.createOperation);
...
router.post('/admissions', authorizeRoles(Permissions.MANAGE_ADMISSIONS), auditLog('CREATE', 'admission'), medicalController.createAdmission);
...
router.post('/admissions/:id/notes', authorizeRoles(Permissions.MANAGE_ADMISSIONS), auditLog('CREATE', 'admission_note'), medicalController.addInpatientNote);
...
router.post('/admissions/:id/settle_and_discharge', authorizeRoles(Permissions.MANAGE_ADMISSIONS), auditLog('UPDATE', 'admission'), medicalController.settleAndDischarge); 
