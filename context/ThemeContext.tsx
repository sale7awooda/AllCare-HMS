...
export type AccentColor = 
  | 'blue' | 'teal' | 'violet' | 'fuchsia' | 'rose' | 'orange' | 'cyan' | 'emerald' 
  | 'indigo' | 'pink' | 'amber' | 'slate' | 'zinc' | 'stone' | 'red' | 'orange' 
  | 'yellow' | 'lime' | 'green' | 'sky' | 'violet' | 'purple';
...
export const colorPalettes: Record<string, Record<number, string>> = {
  ...
  lime: { 50: '#f7fee7', 100: '#ecfcc1', 200: '#d9f99d', 300: '#bef264', 400: '#a3e635', 500: '#84cc16', 600: '#65a30d', 700: '#4d7c0f', 800: '#3f6212', 900: '#365314' },
